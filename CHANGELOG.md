...
### Changed
- **BREAKING**: コマンド名を変更してより直感的に
  - `kagi import` → `kagi show` (シークレットを表示)
  - `kagi download` → `kagi export` (ファイルにエクスポート)
...
[0.3.0]: https://github.com/jacoyutorius/kagi/compare/v0.2.0...v0.3.0
